...
static inline void loaddata() {
    mnist_load("../data/mnist/train-images.idx3-ubyte", "../data/mnist/train-labels.idx1-ubyte",
               &train_set, &Rtrain_cnt);
    mnist_load("../data/mnist/t10k-images.idx3-ubyte", "../data/mnist/t10k-labels.idx1-ubyte",
               &test_set, &Rtest_cnt);
}
...
int main(int argc, const char **argv) {
    ...
    for (int f = 0; f < NUM_FRAMES; ++f) {
        double sec = forward_pass(test_set[f % Rtest_cnt].data);
        ms.push_back(sec * 1000.0);
    }
    ...
    printf("=========================================\n");
    printf(" ResNet (EdgeNN original, unmodified forward_pass)\n");
    printf("   offset  = %.2f\n", offset);
